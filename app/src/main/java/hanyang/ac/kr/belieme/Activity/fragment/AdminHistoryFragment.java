        ...
        switch(item.getStatus()) {
            case REQUESTED: {
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        item.setManagerId(Integer.parseInt(Globals.userInfo.getStudentId()));
                        item.setManagerName(Globals.userInfo.getName());
                        item.setStatus(HistoryStatus.USING);
            ...
            case USING: {
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        item.setStatus(HistoryStatus.RETURNED);
                        HistoryEditTask historyEditTask = new HistoryEditTask();
                        historyEditTask.execute(item);
                    }
                });
