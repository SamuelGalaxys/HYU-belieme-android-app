...
public class ItemRequest {
    ...
    public static ArrayList<Item> addItem(Item item) throws IOException, JSONException, InternalServerException {
        String output = "";
    ...
    public static Item activateItem(int id) throws IOException, JSONException, InternalServerException {
        String output = "";
    ...
    public static Item deactivateItem(int id) throws IOException, JSONException, InternalServerException {
        String output = "";
